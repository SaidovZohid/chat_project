...
type UserServiceClient interface {
	...
	SetUserImage(ctx context.Context, in *SetUserImageRequest, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) SetUserImage(ctx context.Context, in *SetUserImageRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/genproto.UserService/SetUserImage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	SetUserImage(context.Context, *SetUserImageRequest) (*User, error)
...
func (UnimplementedUserServiceServer) SetUserImage(context.Context, *SetUserImageRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetUserImage not implemented")
}
...
func _UserService_SetUserImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserImageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetUserImage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.UserService/SetUserImage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetUserImage(ctx, req.(*SetUserImageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_SetUserImage_Handler,
		},
		{
